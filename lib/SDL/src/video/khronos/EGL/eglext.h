...
typedef EGLBoolean (EGLAPIENTRYP PFNEGLCOMPOSITORSETCONTEXTlist_extendPROC) (const EGLint *external_ref_ids, EGLint num_entries);
...
typedef EGLBoolean (EGLAPIENTRYP PFNEGLCOMPOSITORSETWINDOWlist_extendPROC) (EGLint external_ref_id, const EGLint *external_win_ids, EGLint num_entries);
...
#ifdef EGL_EGLEXT_PROTOTYPES
EGLAPI EGLBoolean EGLAPIENTRY eglCompositorSetContextlist_extend (const EGLint *external_ref_ids, EGLint num_entries);
...
EGLAPI EGLBoolean EGLAPIENTRY eglCompositorSetWindowlist_extend (EGLint external_ref_id, const EGLint *external_win_ids, EGLint num_entries);
