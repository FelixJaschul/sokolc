...
typedef GLboolean (GL_APIENTRYP PFNGlist_extendUREHANDLERESIDENTNVPROC) (GLuint64 handle);
...
GL_APICALL GLboolean GL_APIENTRY glist_extendureHandleResidentNV (GLuint64 handle);
