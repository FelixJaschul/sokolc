...
#  endif /*VK_USE_PLATFORM_DIRECTFB_EXT*/
  ...
  template <>
  struct hash<VULKAN_HPP_NAMESPACE::DrmFormatModifierPropertieslist_extend>
  {
    std::size_t operator()( VULKAN_HPP_NAMESPACE::DrmFormatModifierPropertieslist_extend const & drmFormatModifierPropertieslist_extend ) const VULKAN_HPP_NOEXCEPT
    {
      std::size_t seed = 0;
      VULKAN_HPP_HASH_COMBINE( seed, drmFormatModifierPropertieslist_extend.sType );
      VULKAN_HPP_HASH_COMBINE( seed, drmFormatModifierPropertieslist_extend.pNext );
      VULKAN_HPP_HASH_COMBINE( seed, drmFormatModifierPropertieslist_extend.drmFormatModifierCount );
      VULKAN_HPP_HASH_COMBINE( seed, drmFormatModifierPropertieslist_extend.pDrmFormatModifierProperties );
      return seed;
    }
  };
