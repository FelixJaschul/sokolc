...
static void ImGui_ImplVulkan_CreatePipeline(VkDevice device, const VkAllocationCallbacks* allocator, VkPipelineCache pipelineCache, VkRenderPass renderPass, VkSampleCountFlagBits MSAASamples, VkPipeline* pipeline, uint32_t subpass)
{
    ...
    VkPipelineVertexInputStateCreateInfo vermat_info = {};
    vermat_info.sType = VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO;
    vermat_info.vertexBindingDescriptionCount = 1;
    vermat_info.pVertexBindingDescriptions = binding_desc;
    vermat_info.vertexAttributeDescriptionCount = 3;
    vermat_info.pVertexAttributeDescriptions = attribute_desc;
    ...
    info.stageCount = 2;
    info.pStages = stage;
    info.pVertexInputState = &vermat_info;
