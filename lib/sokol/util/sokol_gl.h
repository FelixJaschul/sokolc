...
SOKOL_GL_API_DECL void *sgl_create_state(void);
SOKOL_GL_API_DECL void sgl_set_state(void *state);
SOKOL_GL_API_DECL void sgl_destroy_state(void *state);
...
//
// >>public
SOKOL_API_IMPL void *sgl_create_state(void) {
    return calloc(1, sizeof(_sgl_t));
}

SOKOL_API_IMPL void sgl_set_state(void *state) {
    _sgl = state;
}

SOKOL_API_IMPL void sgl_destroy_state(void *state) {
    free(state);
}
