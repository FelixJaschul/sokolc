...
SOKOL_IMGUI_API_DECL void *simgui_create_state(void);
SOKOL_IMGUI_API_DECL void simgui_set_state(void *state);
SOKOL_IMGUI_API_DECL void simgui_destroy_state(void *state);
...
void *simgui_create_state(void) {
    return calloc(1, sizeof(_simgui_state_t));
}

void simgui_set_state(void *state) {
    _simgui = state;
}

void simgui_destroy_state(void *state) {
    free(state);
}
