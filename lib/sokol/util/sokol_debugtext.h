...
SOKOL_DEBUGTEXT_API_DECL sdtx_font_desc_t sdtx_font_ztl13(void);
...
static const uint8_t _sdtx_font_ztl13[2048] = {
...
SOKOL_API_IMPL sdtx_font_desc_t sdtx_font_ztl13(void) {
    sdtx_font_desc_t desc = { { _sdtx_font_ztl13, sizeof(_sdtx_font_ztl13) }, 0, 255 };
    return desc;
}
